    ...
    <>
      <section className="caribe">
        ...
        <article className="caribe__text">
          ...
          <p className="caribe__description">
            At The Fives Hotels &amp; Residences, we create experiences that
            awaken your senses and immerse you in a multi-sensory journey.
            Located in the Riviera Maya, Playa del Carmen and Puerto Morelos,
            our resorts are havens that offer not only a luxurious stay, but
            also authentic local immersions that sharpen your five senses.
          </p>

          <p className="caribe__description">
            The Fives Downtown takes you to the heart of Playa del Carmen&apos;s
            5th Avenue, where vibrant restaurants, bars, and boutiques become
            your adventure companions. The Fives Beach embraces you among its
            magical landscapes, enigmatic spaces, and endless possibilities to
