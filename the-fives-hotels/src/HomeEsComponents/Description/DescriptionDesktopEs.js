      ...
      <section className="caribe">
        ...
        <article className="caribe__text">
          ...
          <p className="caribe__description">
            ...
            trascenderán el significado de hospitalidad al cautivar cada uno de
            tus sentidos mediante el distintivo concepto &quot;ALL SENSES
          ...
          <p className="caribe__description">
            <p>
              ...
              &amp; Residences te envuelve con paisajes mágicos, espacios
              enigmáticos y un abanico de posibilidades para experimentar,
              mientras que The Fives Oceanfront Puerto Morelos, en la Riviera
              Cancún, te invita a una experiencia relajante junto al océano, en
              un santuario de arenas blancas y aguas turquesas.
            </p>
          </p>
          <p className="caribe__description">
