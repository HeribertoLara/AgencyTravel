        ...
        <div className={styles.follow}>
          ...
          <ul className={styles.socialLinks}>
            <li>
              ...
              >
                <Image src="/assets/fb_icon.svg" width={20} height={20} alt="#"/>
              </a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Image src="/assets/insta_icon.svg" width={20} height={20} alt="#"/>
              </a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Image src="/assets/yt_icon.svg" width={20} height={20} alt="#"/>
              </a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Image src="/assets/twt_icon.svg" width={20} height={20} alt="#"/>
              </a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Image src="/assets/in_icon.svg" width={20} height={20} alt="#"/>
              </a>
            </li>
          </ul>
        </div>
